...
$res=$con->query("select * from `tb_jlogin` where `id`='$wid'");
$count=$res->num_rows;
...
<input type="hidden"  name="id"  value="<?Php echo $row["id"];?>" class="form-control" id="login-email" required>
        <label for="login-email">Name:</label>
        <input type="text"  name="jname"  value="<?Php echo $row["jname"];?>" class="form-control" id="login-email" required>
      </div>
	   <div class="form-group">
        <label for="login-email">Email:</label>
        <input type="email"  name="jemail" value="<?Php echo $row["jemail"];?>" class="form-control" id="login-email" required>
      </div>
	   <div class="form-group">
        <label for="login-email">Phone No:</label>
        <input type="text"  name="jphoneno" value="<?Php echo $row["jphoneno"];?>" class="form-control" id="login-email" required>
      </div>
      <div class="form-group">
        <label for="login-password">Password:</label>
        <input type="password" name="jpassword" value="<?Php echo $row["jpassword"];?>" class="form-control" id="login-password" required>
      </div>
      <div class="form-group">
