...
$res=$con->query("select * from `tb_rlogin` where `id`='$id'");
$count=$res->num_rows;
						...
						{					
							...
							{
                            ?>
<form action="updateyourprofile.php" method="post">
<div class="form-group">
<input type="hidden"  name="id"  value="<?Php echo $row["Id"];?>" class="form-control">
        <label for="login-email">Name:</label>
        <input type="text"  name="jname"  value="<?Php echo $row["rname"];?>" class="form-control" id="login-email" required>
      </div>
	   <div class="form-group">
        <label for="login-email">Email:</label>
        <input type="email"  name="jemail" value="<?Php echo $row["remail"];?>" class="form-control" id="login-email" required>
      </div>
	   <div class="form-group">
        <label for="login-email">Phone No:</label>
        <input type="text"  name="jphoneno" pattern="[0-9]{10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="<?Php echo $row["rphoneno"];?>" class="form-control" id="login-email" required>
      </div>
      <div class="form-group">
        <label for="login-password">Password:</label>
        <input type="text" name="jpassword" value="<?Php echo $row["rpassword"];?>" class="form-control" id="login-password" required>
      </div>
      <div class="form-group">
